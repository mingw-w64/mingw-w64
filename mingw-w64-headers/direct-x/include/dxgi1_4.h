/*** Autogenerated by WIDL 1.6 from direct-x/include/dxgi1_4.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE IDXGIAdapter3_RegisterHardwareContentProtectionTeardownStatusEvent_Proxy(
    IDXGIAdapter3* This,
    HANDLE event,
    DWORD *cookie);
void __RPC_STUB IDXGIAdapter3_RegisterHardwareContentProtectionTeardownStatusEvent_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IDXGIAdapter3_UnregisterHardwareContentProtectionTeardownStatus_Proxy(
    IDXGIAdapter3* This,
    DWORD cookie);
void __RPC_STUB IDXGIAdapter3_UnregisterHardwareContentProtectionTeardownStatus_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXGIAdapter3_QueryVideoMemoryInfo_Proxy(
    IDXGIAdapter3* This,
    UINT node_index,
    DXGI_MEMORY_SEGMENT_GROUP segment_group,
    DXGI_QUERY_VIDEO_MEMORY_INFO *memory_info);
void __RPC_STUB IDXGIAdapter3_QueryVideoMemoryInfo_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXGIAdapter3_SetVideoMemoryReservation_Proxy(
    IDXGIAdapter3* This,
    UINT node_index,
    DXGI_MEMORY_SEGMENT_GROUP segment_group,
    UINT64 reservation);
void __RPC_STUB IDXGIAdapter3_SetVideoMemoryReservation_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXGIAdapter3_RegisterVideoMemoryBudgetChangeNotificationEvent_Proxy(
    IDXGIAdapter3* This,
    HANDLE event,
    DWORD *cookie);
void __RPC_STUB IDXGIAdapter3_RegisterVideoMemoryBudgetChangeNotificationEvent_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IDXGIAdapter3_UnregisterVideoMemoryBudgetChangeNotification_Proxy(
    IDXGIAdapter3* This,
    DWORD cookie);
void __RPC_STUB IDXGIAdapter3_UnregisterVideoMemoryBudgetChangeNotification_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
