/*** Autogenerated by WIDL 1.6 from direct-x/include/d3d11_2.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE ID3D11DeviceContext2_UpdateTileMappings_Proxy(
    ID3D11DeviceContext2* This,
    ID3D11Resource *resource,
    UINT region_count,
    const D3D11_TILED_RESOURCE_COORDINATE *region_start_coordinates,
    ...
    const UINT *range_tile_counts,
    UINT flags);
void __RPC_STUB ID3D11DeviceContext2_UpdateTileMappings_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3D11DeviceContext2_CopyTileMappings_Proxy(
    ID3D11DeviceContext2* This,
    ID3D11Resource *dst_resource,
    const D3D11_TILED_RESOURCE_COORDINATE *dst_start_coordinate,
    ID3D11Resource *src_resource,
    ...
    const D3D11_TILE_REGION_SIZE *region_size,
    UINT flags);
void __RPC_STUB ID3D11DeviceContext2_CopyTileMappings_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE ID3D11DeviceContext2_CopyTiles_Proxy(
    ID3D11DeviceContext2* This,
    ID3D11Resource *resource,
    const D3D11_TILED_RESOURCE_COORDINATE *start_coordinate,
    const D3D11_TILE_REGION_SIZE *size,
    ...
    UINT64 start_offset,
    UINT flags);
void __RPC_STUB ID3D11DeviceContext2_CopyTiles_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE ID3D11DeviceContext2_UpdateTiles_Proxy(
    ID3D11DeviceContext2* This,
    ID3D11Resource *dst_resource,
    const D3D11_TILED_RESOURCE_COORDINATE *dst_start_coordinate,
    const D3D11_TILE_REGION_SIZE *dst_region_size,
    const void *src_data,
    UINT flags);
void __RPC_STUB ID3D11DeviceContext2_UpdateTiles_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3D11DeviceContext2_ResizeTilePool_Proxy(
    ID3D11DeviceContext2* This,
    ID3D11Buffer *pool,
    UINT64 size);
void __RPC_STUB ID3D11DeviceContext2_ResizeTilePool_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE ID3D11DeviceContext2_TiledResourceBarrier_Proxy(
    ID3D11DeviceContext2* This,
    ID3D11DeviceChild *before_barrier,
    ID3D11DeviceChild *after_barrier);
void __RPC_STUB ID3D11DeviceContext2_TiledResourceBarrier_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
WINBOOL STDMETHODCALLTYPE ID3D11DeviceContext2_IsAnnotationEnabled_Proxy(
    ID3D11DeviceContext2* This);
void __RPC_STUB ID3D11DeviceContext2_IsAnnotationEnabled_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE ID3D11DeviceContext2_SetMarkerInt_Proxy(
    ID3D11DeviceContext2* This,
    const WCHAR *label,
    int data);
void __RPC_STUB ID3D11DeviceContext2_SetMarkerInt_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE ID3D11DeviceContext2_BeginEventInt_Proxy(
    ID3D11DeviceContext2* This,
    const WCHAR *label,
    int data);
void __RPC_STUB ID3D11DeviceContext2_BeginEventInt_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE ID3D11DeviceContext2_EndEvent_Proxy(
    ID3D11DeviceContext2* This);
void __RPC_STUB ID3D11DeviceContext2_EndEvent_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
void STDMETHODCALLTYPE ID3D11Device2_GetImmediateContext2_Proxy(
    ID3D11Device2* This,
    ID3D11DeviceContext2 **context);
void __RPC_STUB ID3D11Device2_GetImmediateContext2_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3D11Device2_CreateDeferredContext2_Proxy(
    ID3D11Device2* This,
    UINT flags,
    ID3D11DeviceContext2 **context);
void __RPC_STUB ID3D11Device2_CreateDeferredContext2_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE ID3D11Device2_GetResourceTiling_Proxy(
    ID3D11Device2* This,
    ID3D11Resource *resource,
    UINT *tile_count,
    D3D11_PACKED_MIP_DESC *mip_desc,
    ...
    UINT first_subresource_tiling,
    D3D11_SUBRESOURCE_TILING *subresource_tiling);
void __RPC_STUB ID3D11Device2_GetResourceTiling_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3D11Device2_CheckMultisampleQualityLevels1_Proxy(
    ID3D11Device2* This,
    DXGI_FORMAT format,
    UINT sample_count,
    UINT flags,
    UINT *quality_level_count);
void __RPC_STUB ID3D11Device2_CheckMultisampleQualityLevels1_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
