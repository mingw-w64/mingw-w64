/*** Autogenerated by WIDL 1.6 from direct-x/include/dxgi1_5.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE IDXGIDevice4_OfferResources1_Proxy(
    IDXGIDevice4* This,
    UINT resource_count,
    IDXGIResource *const *resources,
    DXGI_OFFER_RESOURCE_PRIORITY priority,
    UINT flags);
void __RPC_STUB IDXGIDevice4_OfferResources1_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDXGIDevice4_ReclaimResources1_Proxy(
    IDXGIDevice4* This,
    UINT resource_count,
    IDXGIResource *const *resources,
    DXGI_RECLAIM_RESOURCE_RESULTS *results);
void __RPC_STUB IDXGIDevice4_ReclaimResources1_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IDXGIFactory5_CheckFeatureSupport_Proxy(
    IDXGIFactory5* This,
    DXGI_FEATURE feature,
    void *support_data,
    UINT support_data_size);
void __RPC_STUB IDXGIFactory5_CheckFeatureSupport_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
