...
#define IShellService_SetOwner(This,punkOwner) (This)->lpVtbl->SetOwner(This,punkOwner)
  ...
  enum __MIDL___MIDL_itf_shdeprecated_pub_0407_0001 {
    SECURELOCK_NOCHANGE = -1,SECURELOCK_SET_UNSECURE = 0,SECURELOCK_SET_MIXED = SECURELOCK_SET_UNSECURE + 1,
    SECURELOCK_SET_SECUREUNKNOWNBIT = SECURELOCK_SET_MIXED + 1,SECURELOCK_SET_SECURE40BIT = SECURELOCK_SET_SECUREUNKNOWNBIT + 1,
    SECURELOCK_SET_SECURE56BIT = SECURELOCK_SET_SECURE40BIT + 1,SECURELOCK_SET_FORTEZZA = SECURELOCK_SET_SECURE56BIT + 1,
    SECURELOCK_SET_SECURE128BIT = SECURELOCK_SET_FORTEZZA + 1,SECURELOCK_FIRSTSUGGEST = SECURELOCK_SET_SECURE128BIT + 1,
    SECURELOCK_SUGGEST_UNSECURE = SECURELOCK_FIRSTSUGGEST,SECURELOCK_SUGGEST_MIXED = SECURELOCK_SUGGEST_UNSECURE + 1,
    SECURELOCK_SUGGEST_SECUREUNKNOWNBIT = SECURELOCK_SUGGEST_MIXED + 1,SECURELOCK_SUGGEST_SECURE40BIT = SECURELOCK_SUGGEST_SECUREUNKNOWNBIT + 1,
    SECURELOCK_SUGGEST_SECURE56BIT = SECURELOCK_SUGGEST_SECURE40BIT + 1,SECURELOCK_SUGGEST_FORTEZZA = SECURELOCK_SUGGEST_SECURE56BIT + 1,
