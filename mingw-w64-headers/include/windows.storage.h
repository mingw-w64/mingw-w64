/*** Autogenerated by WIDL 1.5.31 from include/windows.storage.idl - Do not edit ***/
...
#define IApplicationData_DataChanged(This,handler,token) (This)->lpVtbl->DataChanged(This,handler,token)
...
static FORCEINLINE HRESULT IApplicationData_DataChanged(IApplicationData* This,IInspectable *handler,EventRegistrationToken *token) {
...
/*****************************************************************************
 * ApplicationDataSetVersionHandler interface (v0.0)
 */
