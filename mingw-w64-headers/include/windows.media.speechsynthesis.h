/*** Autogenerated by WIDL 9.17 from include/windows.media.speechsynthesis.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT __x_ABI_CWindows_CMedia_CSpeechSynthesis_CIVoiceInformation_get_Gender(__x_ABI_CWindows_CMedia_CSpeechSynthesis_CIVoiceInformation* This,__x_ABI_CWindows_CMedia_CSpeechSynthesis_CVoiceGender *value) {
...
/*** ISpeechSynthesizerOptions3 methods ***/
static __WIDL_INLINE HRESULT __x_ABI_CWindows_CMedia_CSpeechSynthesis_CISpeechSynthesizerOptions3_get_AppendedSilence(__x_ABI_CWindows_CMedia_CSpeechSynthesis_CISpeechSynthesizerOptions3* This,__x_ABI_CWindows_CMedia_CSpeechSynthesis_CSpeechAppendedSilence *value) {
    return This->lpVtbl->get_AppendedSilence(This,value);
}
static __WIDL_INLINE HRESULT __x_ABI_CWindows_CMedia_CSpeechSynthesis_CISpeechSynthesizerOptions3_put_AppendedSilence(__x_ABI_CWindows_CMedia_CSpeechSynthesis_CISpeechSynthesizerOptions3* This,__x_ABI_CWindows_CMedia_CSpeechSynthesis_CSpeechAppendedSilence value) {
    return This->lpVtbl->put_AppendedSilence(This,value);
}
static __WIDL_INLINE HRESULT __x_ABI_CWindows_CMedia_CSpeechSynthesis_CISpeechSynthesizerOptions3_get_PunctuationSilence(__x_ABI_CWindows_CMedia_CSpeechSynthesis_CISpeechSynthesizerOptions3* This,__x_ABI_CWindows_CMedia_CSpeechSynthesis_CSpeechPunctuationSilence *value) {
    return This->lpVtbl->get_PunctuationSilence(This,value);
}
static __WIDL_INLINE HRESULT __x_ABI_CWindows_CMedia_CSpeechSynthesis_CISpeechSynthesizerOptions3_put_PunctuationSilence(__x_ABI_CWindows_CMedia_CSpeechSynthesis_CISpeechSynthesizerOptions3* This,__x_ABI_CWindows_CMedia_CSpeechSynthesis_CSpeechPunctuationSilence value) {
