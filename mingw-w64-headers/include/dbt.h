...
typedef __MINGW_NAME_UAW(DEV_BROADCAST_PORT) DEV_BROADCAST_PORT;
typedef __MINGW_NAME_UAW(PDEV_BROADCAST_PORT) PDEV_BROADCAST_PORT;
...
typedef __MINGW_NAME_UAW(DEV_BROADCAST_DEVICEINTERFACE) DEV_BROADCAST_DEVICEINTERFACE;
typedef __MINGW_NAME_UAW(PDEV_BROADCAST_DEVICEINTERFACE) PDEV_BROADCAST_DEVICEINTERFACE;
