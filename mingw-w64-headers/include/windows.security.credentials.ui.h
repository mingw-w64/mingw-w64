/*** Autogenerated by WIDL 9.17 from include/windows.security.credentials.ui.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT __FIAsyncOperation_1_UserConsentVerificationResult_GetResults(__FIAsyncOperation_1_UserConsentVerificationResult* This,__x_ABI_CWindows_CSecurity_CCredentials_CUI_CUserConsentVerificationResult *results) {
...
static __WIDL_INLINE HRESULT __FIAsyncOperation_1_UserConsentVerifierAvailability_GetResults(__FIAsyncOperation_1_UserConsentVerifierAvailability* This,__x_ABI_CWindows_CSecurity_CCredentials_CUI_CUserConsentVerifierAvailability *results) {
    return This->lpVtbl->GetResults(This,results);
}
#endif
#ifdef WIDL_using_Windows_Foundation
