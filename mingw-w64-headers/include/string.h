...
#define _CRT_MEMORY_DEFINED
...
#else
  _CRTIMP void *__cdecl memmove(void *_Dst,const void *_Src,size_t _Size);
#endif
  ...
  _CRTIMP int __cdecl strnicmp(const char *_Str1,const char *_Str,size_t _MaxCount);
  ...
  _CRTIMP char *__cdecl strnset(char *_Str,int _Val,size_t _MaxCount);
  _CRTIMP char *__cdecl strrev(char *_Str);
  char *__cdecl strset(char *_Str,int _Val);
  _CRTIMP char *__cdecl strupr(char *_Str);
#endif
