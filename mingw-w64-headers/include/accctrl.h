...
#define AccFree LocalFree
  ...
  typedef enum _MULTIPLE_TRUSTEE_OPERATION {
    ...
    typedef __MINGW_NAME_UAW(OBJECTS_AND_NAME) OBJECTS_AND_NAME_;
    typedef __MINGW_NAME_UAW(POBJECTS_AND_NAME) POBJECTS_AND_NAME_;
    ...
    typedef __MINGW_NAME_UAW(TRUSTEE) TRUSTEE_;
    typedef __MINGW_NAME_UAW(PTRUSTEE) PTRUSTEE_;
...
#define INHERITED_GRANDPARENT 0x20000000
    ...
    typedef __MINGW_NAME_UAW(EXPLICIT_ACCESS) EXPLICIT_ACCESS_;
    typedef __MINGW_NAME_UAW(PEXPLICIT_ACCESS) PEXPLICIT_ACCESS_;
