/*** Autogenerated by WIDL 9.18 from include/mfmediaengine.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IMFMediaEngineEx_IsProtected(IMFMediaEngineEx* This,WINBOOL *is_protected) {
