...
#define SCARD_ATTR_DEVICE_FRIENDLY_NAME __MINGW_NAME__AW(SCARD_ATTR_DEVICE_FRIENDLY_NAME)
#define SCARD_ATTR_DEVICE_SYSTEM_NAME __MINGW_NAME__AW(SCARD_ATTR_DEVICE_SYSTEM_NAME)
