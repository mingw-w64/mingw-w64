...
#include <shlguid.h>
#if 0
DEFINE_GUID(CLSID_ShellDesktop,0x00021400L,0,0);
DEFINE_GUID(CLSID_ShellLink,0x00021401L,0,0);
DEFINE_GUID(FMTID_Intshcut,0x000214A0L,0,0);
DEFINE_GUID(FMTID_InternetSite,0x000214A1L,0,0);
DEFINE_GUID(CGID_Explorer,0x000214D0L,0,0);
DEFINE_GUID(CGID_ShellDocView,0x000214D1L,0,0);
DEFINE_GUID(CGID_ShellServiceObject,0x000214D2L,0,0);
DEFINE_GUID(IID_INewShortcutHookA,0x000214E1L,0,0);
DEFINE_GUID(IID_IShellBrowser,0x000214E2L,0,0);
DEFINE_GUID(IID_IShellView,0x000214E3L,0,0);
DEFINE_GUID(IID_IContextMenu,0x000214E4L,0,0);
DEFINE_GUID(IID_IQueryInfo,0x00021500L,0,0);
DEFINE_GUID(IID_IShellIcon,0x000214E5L,0,0);
DEFINE_GUID(IID_IShellFolder,0x000214E6L,0,0);
DEFINE_GUID(IID_IShellExtInit,0x000214E8L,0,0);
DEFINE_GUID(IID_IShellPropSheetExt,0x000214E9L,0,0);
DEFINE_GUID(IID_IPersistFolder,0x000214EAL,0,0);
DEFINE_GUID(IID_IExtractIconA,0x000214EBL,0,0);
DEFINE_GUID(IID_IShellLinkA,0x000214EEL,0,0);
DEFINE_GUID(IID_IShellCopyHookA,0x000214EFL,0,0);
DEFINE_GUID(IID_IFileViewerA,0x000214F0L,0,0);
DEFINE_GUID(IID_ICommDlgBrowser,0x000214F1L,0,0);
DEFINE_GUID(IID_IEnumIDList,0x000214F2L,0,0);
DEFINE_GUID(IID_IFileViewerSite,0x000214F3L,0,0);
DEFINE_GUID(IID_IContextMenu2,0x000214F4L,0,0);
DEFINE_GUID(IID_IContextMenu3,0xBCFCE0A0,0xEC17,0x11D0,0x8D,0x10,0x0,0xA0,0xC9,0xF,0x27,0x19);
DEFINE_GUID(IID_IShellExecuteHookA,0x000214F5L,0,0);
DEFINE_GUID(IID_IPropSheetPage,0x000214F6L,0,0);
DEFINE_GUID(IID_INewShortcutHookW,0x000214F7L,0,0);
DEFINE_GUID(IID_IFileViewerW,0x000214F8L,0,0);
DEFINE_GUID(IID_IShellLinkW,0x000214F9L,0,0);
DEFINE_GUID(IID_IExtractIconW,0x000214FAL,0,0);
DEFINE_GUID(IID_IShellExecuteHookW,0x000214FBL,0,0);
DEFINE_GUID(IID_IShellCopyHookW,0x000214FCL,0,0);
