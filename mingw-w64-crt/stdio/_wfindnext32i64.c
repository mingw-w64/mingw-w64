...
#ifndef _WIN64
#undef _wfindnexti64
int __attribute__ ((alias ("_wfindnext32i64"))) __cdecl _wfindnexti64(intptr_t, struct _wfinddata32i64_t *);
extern int __attribute__ ((alias (__MINGW64_STRINGIFY(__MINGW_IMP_SYMBOL(_wfindnext32i64))))) (__cdecl *__MINGW_IMP_SYMBOL(_wfindnexti64))(intptr_t, struct _wfinddata32i64_t *);
#endif
